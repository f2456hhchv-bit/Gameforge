...
export const COLLECTIONS = {
  ...
  dialogueNodes: { label: 'Dialogue Nodes', icon: '💬', group: 'Design' },
  playtestSessions: { label: 'Playtest Sessions', icon: '🧪', group: 'Live Ops' },
  liveOpsEvents: { label: 'LiveOps Events', icon: '📅', group: 'Live Ops' },
  locStrings: { label: 'Localization Strings', icon: '🌐', group: 'Live Ops' },
  telemetryEvents: { label: 'Telemetry Events', icon: '📈', group: 'Live Ops' },
  controlBindings: { label: 'Control Bindings', icon: '🎮', group: 'Production' },
